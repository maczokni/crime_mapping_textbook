...
tm_shape(manchester_crime_lsoa) + 
  ...
  tm_legend(title = "Crime counts", position = c("right", "bottom"), title.size = 0.8)
```
...
map1 <- tm_shape(manchester_crime_lsoa) +  # Specify spatial object
  tm_fill("count", fill.scale = tm_scale_intervals(style="equal")) +  # Define fill variable and classification
  tm_title("Equal") + 
  tm_legend(
...
map2 <- tm_shape(manchester_crime_lsoa) +  # Specify spatial object
  tm_fill("count", fill.scale = tm_scale_intervals(style="jenks")) +  # Define fill variable and classification
  tm_title("Jenks") + 
  tm_legend(
    position = c("right", "bottom"),
    title.size = 0.8,
...
map3 <- tm_shape(manchester_crime_lsoa) +
  tm_fill("count", fill.scale = tm_scale_intervals(style="quantile")) +
  tm_title("Quantile") + 
  tm_legend(
    position = c("right", "bottom"),
    title.size = 0.8,
...
map4 <- tm_shape(manchester_crime_lsoa) +
  tm_fill("count", fill.scale = tm_scale_intervals(style="sd")) +
...
crime_rate_map <- tm_shape(manchester_crime_lsoa) + 
  tm_fill("crimr1", fill.scale = tm_scale_intervals(values = "brewer.reds"), 
          fill.legend = tm_legend(
      ...
      text.size = 0.5)) + 
  tm_title("Crime rate") + 
  tm_legend(position = c("right", "bottom"), title.size = 0.8, text.size = 0.5)
