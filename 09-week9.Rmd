...
Decomposing these trends is an important part of what **time series** analysis is all about. This could be a whole other course (and it is, there are modules on this for example in Economics department!) so we will not cover here. HOWEVER, I will show you one super cool way to introduce *time* into your crime mapping practice. We'll try to things: small multiples, and animations. 
